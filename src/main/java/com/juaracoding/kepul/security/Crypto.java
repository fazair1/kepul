...
public class Crypto {
    ...
    private static final String defaultKey = "16db05b3f22f277dfad6fe67711c96b0829f3894f6f090c46db222a002207fc1";
...
//        String strToEncrypt = "debytesting16@gmail.com";//put text to encrypt in here
        String strToEncrypt = "kepul.123";//put text to encrypt in here
...
//        String strToDecrypt = "0d3f28a8cb0577e4fd42fbfdf2f72eac";//put text to decrypt in here
        String strToDecrypt = "adsasd";//put text to decrypt in here
